export class Byte {
    static readonly BIG_ENDIAN = "bigEndian";
    static readonly LITTLE_ENDIAN = "littleEndian";
    ...
    getFloat32Array(start: number, len: number) {
        return this.readFloat32Array(start, len);
    }
    readFloat32Array(start: number, len: number) {
        var end = start + len;
    ...
    getUint8Array(start: number, len: number) {
        return this.readUint8Array(start, len);
    }
    readUint8Array(start: number, len: number) {
        var end = start + len;
        end = (end > this._length) ? this._length : end;
    ...
    getInt16Array(start: number, len: number) {
        return this.readInt16Array(start, len);
    }
    readInt16Array(start: number, len: number) {
        var end = start + len;
        end = (end > this._length) ? this._length : end;
