...
declare interface CfgSecret extends ICfgExtension<CfgSecretData>, ICfgReadOnly<CfgSecretData> {
	/** 无尽深渊[普通] */
...
declare interface CfgSecretData extends ICfgReadOnly {
	/**  */
	readonly id: number;
	/** 名字 */
...
declare interface CfgSecretData1 extends ICfgReadOnly {
	readonly id: number;
	readonly count: number;
}

declare interface CfgSecretData2 extends ICfgReadOnly {
	readonly id: number;
	readonly count: number;
