...
import UILoading3 from "./UILoading3";
import { UILoading3View } from "../../view/PkgCommon/view/UILoading3View";
import UILoading4 from "./UILoading4";
import { UILoading4View } from "../../view/PkgCommon/view/UILoading4View";
import UILoading5 from "./UILoading5";
import { UILoading5View } from "../../view/PkgCommon/view/UILoading5View";
...
export default class PkgCommonBinder {
	public static bindAll(): void {
		...
		fgui.UIObjectFactory.setExtension(UILoading3.url, UILoading3View);
		fgui.UIObjectFactory.setExtension(UILoading4.url, UILoading4View);
		fgui.UIObjectFactory.setExtension(UILoading5.url, UILoading5View);
