...
export default class UIMain extends fgui.GComponent {
	...
	protected override onConstruct():void {
		...
		this.BtnInfo = <fgui.GGraph>(this.getChildAt(14));
		this.TxtNickName = <fgui.GTextField>(this.getChildAt(17));
		this.TxtLevel = <fgui.GTextField>(this.getChildAt(19));
		this.TxtExp = <fgui.GTextField>(this.getChildAt(20));
		this.TxtSect = <fgui.GTextField>(this.getChildAt(21));
		this.TxtJinBi = <fgui.GTextField>(this.getChildAt(23));
		this.TxtYuanBao = <fgui.GTextField>(this.getChildAt(24));
		this.BtnHead = <fgui.GLoader>(this.getChildAt(25));
		this.BtnSetting = <fgui.GButton>(this.getChildAt(26));
		this.BtnRank = <fgui.GButton>(this.getChildAt(27));
		this.BtnSphere = <fgui.GButton>(this.getChildAt(29));
	}
}