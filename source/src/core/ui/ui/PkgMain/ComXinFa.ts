...
export default class ComXinFa extends fgui.GComponent {
	...
	public btn_skill0:BtnCornerTxt;
	public btn_skill1:BtnCornerTxt;
	public btn_skill2:BtnCornerTxt;
	public btn_skill3:BtnCornerTxt;
	public btn_upgrade0:BtnCornerTxt;
	public btn_upgrade1:BtnCornerTxt;
	public btn_upgrade2:BtnCornerTxt;
	...
	protected override onConstruct():void {
		...
		this.btn_skill0 = <BtnCornerTxt>(this.getChildAt(14));
		this.btn_skill1 = <BtnCornerTxt>(this.getChildAt(15));
		this.btn_skill2 = <BtnCornerTxt>(this.getChildAt(16));
		this.btn_skill3 = <BtnCornerTxt>(this.getChildAt(17));
		this.btn_upgrade0 = <BtnCornerTxt>(this.getChildAt(18));
		this.btn_upgrade1 = <BtnCornerTxt>(this.getChildAt(19));
		this.btn_upgrade2 = <BtnCornerTxt>(this.getChildAt(20));
	}
}