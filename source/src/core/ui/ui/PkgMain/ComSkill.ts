...
export default class ComSkill extends fgui.GComponent {
	...
	protected override onConstruct():void {
		...
		this.BtnNormal0 = <fgui.GButton>(this.getChildAt(1));
		this.BtnNormal1 = <fgui.GButton>(this.getChildAt(2));
		this.BtnNormal2 = <fgui.GButton>(this.getChildAt(3));
		this.BtnNormal3 = <fgui.GButton>(this.getChildAt(4));
		this.BtnNormal4 = <fgui.GButton>(this.getChildAt(5));
