...
export class ComShangChengCtrl extends BaseViewCtrl<ComShangChengView, ComShangChengData>{
	...
	override onAwake(): void {
		...
		UIUtility.SetList(this.view.ListItem, true, this, this.listRenderer, this.listClick);
	}
	...
	private listClick(item: RenderBagView, __, index: number) {
		this.showView<ComItemInfoData>(ViewID.ComItemInfoView, { id: this.items[ index ].ID, buy: true }, null, false);
	}
