...
import { UIItemInfoCtrl } from "../view/PkgMain/controller/UIItemInfoCtrl";
import { UIItemInfoProxy } from "../view/PkgMain/proxy/UIItemInfoProxy";
import { UIItemInfoView } from "../view/PkgMain/view/UIItemInfoView";
...
class ViewRegister {
    ...
    private viewBind() {
		...
		fgui.UIObjectFactory.setExtension(UIItemInfo.URL, UIItemInfoView);
    ...
    private registerView() {
		...
		register(ViewID.UIItemInfoView, UIItemInfoView, UIItemInfoCtrl, UIItemInfoProxy);
