...
import { UILoading3Ctrl } from "../view/PkgCommon/controller/UILoading3Ctrl";
import { UILoading4View } from "../view/PkgCommon/view/UILoading4View";
import { UILoading4Ctrl } from "../view/PkgCommon/controller/UILoading4Ctrl";
import { UILoading5View } from "../view/PkgCommon/view/UILoading5View";
import { UILoading5Ctrl } from "../view/PkgCommon/controller/UILoading5Ctrl";
...
class ViewRegister {
    ...
    private registerView() {
		...
		register(ViewID.UILoading3View, UILoading3View, UILoading3Ctrl);
		register(ViewID.UILoading4View, UILoading4View, UILoading4Ctrl);
		register(ViewID.UILoading5View, UILoading5View, UILoading5Ctrl);
