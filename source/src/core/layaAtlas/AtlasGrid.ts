...
export class AtlasGrid {
    ...
    private _rowInfo: Uint16Array;
    private _cells: Uint16Array;
    ...
    reset() {
        this._init(this._width, this._height);
    }
    ...
    private _init(width, height) {
        ...
        if (this._width == 0)
            return false;
        this._cells = new Uint16Array(this._width * this._height * 3);
        this._rowInfo = new Uint16Array(this._height);
        this._used = 0;
        this._clear();
        return true;
    }
    private _get(width, height, pt) {
