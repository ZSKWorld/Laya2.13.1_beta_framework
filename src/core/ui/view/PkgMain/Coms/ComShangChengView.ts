...
export class ComShangChengView extends ExtensionClass<ViewExtension, ComShangCheng>(ComShangCheng) {
	...
	onCreate(): void {
		const { BtnProp, BtnGem, BtnMaterial, BtnMiJi, BtnOther, BtnHeiShi, BtnXianJie, BtnZBQH, BtnBSJG, BtnJS, BtnTSDJ, BtnGemLv1,
			BtnGemLv2, BtnGemLv3, BtnGemLv4, BtnSGCL, BtnTSCL, BtnZW, BtnQHCL, BtnTJ, BtnXF, BtnJN, BtnQT, BtnYR } = this;
