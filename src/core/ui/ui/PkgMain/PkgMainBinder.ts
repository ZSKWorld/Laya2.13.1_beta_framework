...
import RenderLiLian from "./RenderLiLian";
...
export default class PkgMainBinder {
	public static bindAll():void {
		...
		fgui.UIObjectFactory.setExtension(ComWuPin.URL, ComWuPin);
		fgui.UIObjectFactory.setExtension(ComShangCheng.URL, ComShangCheng);
		fgui.UIObjectFactory.setExtension(ComJueSe.URL, ComJueSe);
		fgui.UIObjectFactory.setExtension(ComDongFu.URL, ComDongFu);
		fgui.UIObjectFactory.setExtension(RenderLiLian.URL, RenderLiLian);
